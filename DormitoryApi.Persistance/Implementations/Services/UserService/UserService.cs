    ...
    public class UserService : IUserService
    {
        ...
        public async Task UpdatePasswordAsync(string userId, string resetToken, string newPassword)
        {
            ...
            if (user != null)
            {
                ...
                {
                    throw new GenericCustomException<ExceptionDTO>("Some Things Wrong");
                }
            }
            else
            {
        ...
        public async Task<Response<List<UserGetDTO>>> GetAllUsersAsync()
        {
            ...
            catch (Exception ex) { throw new GenericCustomException<ExceptionDTO>(ex.Message, ex.InnerException); }
        }
        ...
        public async Task<Response<string[]>> GetRolesToUserAsync(string userIdOrName)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new GenericCustomException<ExceptionDTO>(ex.Message, ex.InnerException);
            }
        }
